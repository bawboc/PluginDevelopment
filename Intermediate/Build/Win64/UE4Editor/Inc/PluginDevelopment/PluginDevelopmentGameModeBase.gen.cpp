...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_APluginDevelopmentGameModeBase()
	{
		...
		if (!OuterClass)
		{
			...
			OuterClass = APluginDevelopmentGameModeBase::StaticClass();
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<APluginDevelopmentGameModeBase> > StaticCppClassTypeInfo;
				OuterClass->SetCppTypeInfo(&StaticCppClassTypeInfo);
				OuterClass->StaticLink();
#if WITH_METADATA
				UMetaData* MetaData = OuterClass->GetOutermost()->GetMetaData();
				MetaData->SetValue(OuterClass, TEXT("HideCategories"), TEXT("Info Rendering MovementReplication Replication Actor Input Movement Collision Rendering Utilities|Transformation"));
				MetaData->SetValue(OuterClass, TEXT("IncludePath"), TEXT("PluginDevelopmentGameModeBase.h"));
				MetaData->SetValue(OuterClass, TEXT("ModuleRelativePath"), TEXT("PluginDevelopmentGameModeBase.h"));
	...
	IMPLEMENT_CLASS(APluginDevelopmentGameModeBase, 2594350246);
